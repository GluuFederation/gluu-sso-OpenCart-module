...
class ControllerModuleGluuSSO242 extends Controller
{
    ...
    */
    public function index ($setting)
    {
        ...
        if( isset( $this->request->get['logout_from_gluu'] ) and strpos( $this->request->get['logout_from_gluu'], 'exist' )           !== false ) {
            session_destroy();
        }
        if( isset( $this->request->get['route'] ) and strpos( $this->request->get['route'], 'account/logout' )           !== false ) {
    ...
    */
    public function show_template ($data)
    {
