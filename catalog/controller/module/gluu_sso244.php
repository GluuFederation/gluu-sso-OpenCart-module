...
class ControllerModuleGluuSSO244 extends Controller
{
    ...
    */
    ...
    {
        require_once(DIR_SYSTEM . 'library/oxd-rp-244/Get_authorization_url.php');
        require_once(DIR_SYSTEM . 'library/oxd-rp-244/Get_tokens_by_code.php');
        require_once(DIR_SYSTEM . 'library/oxd-rp-244/Get_user_info.php');
    ...
    */
    public function logout(){
        if( isset( $this->request->get['state'] ) and isset( $this->request->get['session_state'] ) ) {
            ...
            require_once(DIR_SYSTEM . 'library/oxd-rp-244/Logout.php');
            $config_option = json_decode($this->gluu_db_query_select('oxd_config'),true);
            $oxd_id = $this->gluu_db_query_select('oxd_id');
            $logout = new Logout();
    ...
    */
    ...
    {
        $temp = $this->get_template ('module/gluu_sso244');
